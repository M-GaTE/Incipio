...
class MembreType extends AbstractType {
    ...
    public function buildForm(\Symfony\Component\Form\FormBuilderInterface $builder, array $options) {
		...
		->add('nationalite', 'genemu_jqueryselect2_choice', array('label' => 'Nationalité', 'required' => true, 'preferred_choices' => array('Français'), 'choices' => array('Afghan' => 'Afghan', 'Albanais' => 'Albanais',
